...
public class GainSaveListViewAdapter extends ArrayAdapter<String> 
	implements OnClickListener, OnLongClickListener {

	private String TAG = "GainSaveListViewAdapter";
	...
	public GainSaveListViewAdapter(Context context, int resource,
			List<String> objects) {
